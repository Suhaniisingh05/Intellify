...
const Testimonials = () => {
    ...
    const CreateCard = ({ card }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0 font-libre text-white" style={{backgroundColor :card.bgcolor}}>
            <div className="flex gap-2 ">
                ...
                <div className="flex flex-col">
                    ...
                    <span className="text-xs">{card.handle}</span>
                </div>
            </div>
            <p className="text-sm py-4 ">Radiant made undercutting all of our competitors an absolute
                breeze.</p>
    ...
    return (
        ...
        `}</style>
          ...
          <div className='flex flex-col mb-35'> 
            <h1 className='text-center text-[45px] text-[#819877]'>Loved By Creators</h1>
